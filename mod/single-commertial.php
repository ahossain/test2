<?php
/**
 * The Template for displaying all single posts for "post_type_two".
 *
 */
						...
						<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
							...
							<div class="entry-content">		
								...
								<div id="blog-post-type">
									...
									<ul id="slider-post-type" class="commertial"> <!-- class is used in projects-detail.js for post retrive -->
										...
										<li id="post-id-<?php echo $my_id; ?>">	
											<div class="top">
												<div class="left">
													<div class="blogname">
														<span class="category">commertial</span><span class="blogname_white"><?php echo $lastposts->post_title; ?></span>													
													</div>
													<div class="sign">
